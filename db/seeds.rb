...
10.times do
	User.create(last_name:Faker::Name.last_name, first_name:Faker::Name.first_name, email: Faker::Internet.email, age:rand(12..100), description:Faker::Lorem.paragraph, city_id:City.all.sample.id, password: Faker::Food.vegetables )
end
puts "Users created"

20.times do
	Gossip.create(title:Faker::Movies::StarWars.quote, content:Faker::Lorem.paragraph, user_id:User.all.sample.id, gossip_like: 0)
end
